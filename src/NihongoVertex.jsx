...
const NAV = [
  ...
  {key:"syllabus", jp:"シラバス", en:"Syllabus", icon:ListChecks},
  {key:"kanafull", jp:"かな全表", en:"Kana Full Charts", icon:PenLine},
  {key:"kanjifull", jp:"漢字辞典", en:"Kanji Dictionary", icon:BookOpen},
  {key:"quizfull", jp:"クイズ", en:"Quiz Center", icon:ClipboardCheck},
  {key:"characters", jp:"文字ラボ", en:"Kana · Kanji Lab", icon:PenTool},
  {key:"levels", jp:"レベル", en:"Levels", icon:Layers},
